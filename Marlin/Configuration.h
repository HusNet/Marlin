...
#define CUSTOM_MACHINE_NAME "Bitches"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -6.5, -2 }
...
#define Z_PROBE_LOW_POINT          -1.5 // Farthest distance below the trigger-point to go before stopping
